...
// ОПАСНО: operatorsAliases включены НАМЕРЕННО для демонстрации Operator Injection.
// В Sequelize 6.x они по умолчанию ВЫКЛЮЧЕНЫ именно из-за атак вида { "$ne": null }.
// Здесь мы явно возвращаем строковые алиасы ($ne, $gt, $or, ...), чтобы JSON-payload
// вида {"username": {"$ne": null}} с фронтенда транслировался Sequelize в Op.ne.
